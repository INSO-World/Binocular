...
import { convertIssuesToGraphData } from '../../../../../../plugins/visualizationPlugins/authorBehaviour/collaboration/src/utilities/dataConverter';
...
describe('convertIssuesToGraphData', () => {
  it('U1.1 returns empty nodes and links for empty input', () => {
    const result = convertIssuesToGraphData([], settings);
  ...
  it('U1.2 creates one node per account', () => {
    ...
    const result = convertIssuesToGraphData(accounts, settings);
  ...
  it('U1.6 filters out links below minEdgeValue', () => {
    ...
    const result = convertIssuesToGraphData(accounts, strictSettings);
  ...
  it('U1.7 filters out links above maxEdgeValue', () => {
    ...
    const result = convertIssuesToGraphData(accounts, cappedSettings);
