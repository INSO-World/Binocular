...
describe('showVisualizationOverview – vertical positioning', () => {
  it('U49.1 y < innerHeight/2 → top set, bottom: auto', () => {
  ...
  it('U49.2 y >= innerHeight/2 → bottom set, top: auto', () => {
...
describe('showVisualizationOverview – horizontal positioning', () => {
  it('U49.3 x < innerWidth/2 → left set, right: auto', () => {
  ...
  it('U49.4 x >= innerWidth/2 → right set, left: auto', () => {
...
describe('showVisualizationOverview – showModal', () => {
  it('U49.5 calls showModal() on #visualizationOverview', () => {
...
describe('disableVisualizationOverview', () => {
  ...
  it('U49.9 returns false when filter github=true and plugin github=true', () => {
    const filter: VisualizationPluginCompatibility = { ...allFalse, github: true };
  ...
  it('U49.10 returns true on pouchDB key mismatch', () => {
