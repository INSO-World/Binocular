...
export default class ServerDB {
  ...
  static getVulnerabilityDirectTransitiveSnapshots(branch, since, until) {
    return VulnerabilityDirectTransitiveSnapshots.getVulnerabilityDirectTransitiveSnapshots(branch, since, until);
  }
  ...
  static getOutdatedDependencySnapshots(branches, since, until) {
    return OutdatedDependencySnapshots.getOutdatedDependencySnapshots(branches, since, until);
  }

  static getOutdatedDependencyBranches() {
    return OutdatedDependencySnapshots.getOutdatedDependencyBranches();
  }

  static getLicenseComplianceSnapshots(branch, since, until) {
    return LicenseComplianceSnapshots.getLicenseComplianceSnapshots(branch, since, until);
  }
